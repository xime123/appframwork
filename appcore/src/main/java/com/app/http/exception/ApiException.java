...
package com.app.http.exception;
...
public class ApiException extends Exception {
    ...
    public static ApiException handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex.message = TDString.getStr(R.string.PARSE_ERROR);
            return ex;
        } else if (e instanceof ClassCastException) {
            ex = new ApiException(e, ERROR.CAST_ERROR);
            ex.message = TDString.getStr(R.string.CAST_ERROR);
            return ex;
        } else if (e instanceof ConnectException) {
            ex = new ApiException(e, ERROR.NETWORD_ERROR);
            ex.message =TDString.getStr(R.string.NETWORD_ERROR);
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new ApiException(e, ERROR.SSL_ERROR);
            ex.message =TDString.getStr(R.string.SSL_ERROR);
            return ex;
        } else if (e instanceof ConnectTimeoutException) {
            ex = new ApiException(e, ERROR.TIMEOUT_ERROR);
            ex.message = TDString.getStr(R.string.TIMEOUT_ERROR);
            return ex;
            ...
            ex.message = TDString.getStr(R.string.UNKNOWNHOST_ERROR);
            return ex;
        } else {
