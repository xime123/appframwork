 ...
 * 不支持使用QuickAdapter,請使用CommonAdapter
 * 自定义刷新页面
 */

public abstract class BasePullRefreshListActivity<T> extends StatusBarColorActivity implements XRecyclerView.LoadingListener {
    ...
    protected abstract void fetchMoreListItems(@NonNull Map<String, Object> params);
    ...
    protected void initView(ViewGroup contentView) {
        ...
        rvList = (XRecyclerView)findViewById(R.id.xrv_base);
