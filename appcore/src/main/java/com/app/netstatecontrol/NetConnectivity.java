...
public class NetConnectivity {
	...
	private boolean mLastNetState = false;// 上一次收到物理网络广播的时候，网络的状态。刚开始的时候，为未连接。
	private final static int DEFAULT_NETTYPE = -999;
	private int mLastNetType = DEFAULT_NETTYPE;// 上一次收到物理网络广播的时候，网络的类型
	private String mLastWifiSSID = null;// 上一次WIFI连接的SSID。edge网络为null

	private Context mContext;
	private BroadcastReceiver receiver;

	public static final String ACITION_CONNECTIVITY_CHANGE = "com.pagoda.conn.CONNECTIVITY_CHANGE";
	public static final String EXTRA_NETSTATE = "com.pagoda.conn.EXTRA_NETSTATE";
	...
	public boolean isConnected() {
		...
		if (cm != null) {
			...
			if (networkInfo != null) {
				return result = networkInfo.isConnected();
			}
		}
		return result;
	}
